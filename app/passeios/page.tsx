...
export const metadata: Metadata = {
  ...
  description:
    'Conheça os passeios de quadriciclo em Monte Verde MG: Normal, Noturno e Pôr do Sol. Trilhas na Fazenda Adrenalina, guia especializado e equipamentos inclusos.',
  alternates: { canonical: `${SITE_URL}/passeios` },
  openGraph: {
    title: 'Passeios de Quadriciclo em Monte Verde MG | Hyguinho Quadriciclos',
    description:
      'Passeio Normal, Noturno e Pôr do Sol. Trilhas exclusivas na Fazenda Adrenalina para 2 pessoas. Atendimento via WhatsApp.',
    images: [{ url: '/img/passeio-quadriciclo-monte-verde-10.jpeg', width: 1200, height: 630 }],
  },
};
                ...
                <div className={`grid md:grid-cols-2 gap-10 items-center ${i % 2 === 1 ? 'md:[direction:rtl]' : ''}`}>
                  ...
                  <div className={i % 2 === 1 ? 'md:[direction:ltr]' : ''}>
                    ...
                    <div className="grid sm:grid-cols-3 gap-3 mb-8">
                      {tour.practicalInfo.map((info) => (
                        <div key={info} className="rounded-2xl border border-forest-700 bg-forest-800/60 px-4 py-3">
                          <p className="text-[11px] uppercase tracking-widest text-moss mb-1">Info útil</p>
                          <p className="text-sm text-white/75 leading-relaxed">{info}</p>
                        </div>
                      ))}
                    </div>
